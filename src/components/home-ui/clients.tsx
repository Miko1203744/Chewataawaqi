...
const clients = [
  { name: "Client 1", logo: "/alx.png" },
  { name: "Client 2", logo: "/flawles.png" },
  { name: "Client 3", logo: "/heineken.png" },
  { name: "Client 4", logo: "/krinfud.jpg" },
  { name: "Client 5", logo: "/linkup.png" },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-6xl font-bold mb-4">
            Clients We&apos;ve Had <br /> the Pleasure of Work With
          </h2>
